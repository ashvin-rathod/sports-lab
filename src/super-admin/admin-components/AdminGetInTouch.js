                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-md-6">
                                        <ul className="manage-support-ul">
                                            <li>
                                                <span className="sort-name">rw</span>
                                                <div>
                                                    <h5>Rachel Wagner</h5>
                                            ...
                                            <li>
                                                <span className="sort-name">rs</span>
                                                <div>
                                                    <h5>Ryan Stanley</h5>
                                                    <p>Duis porta, ligula rhoncus euismod pretium, nisi tellus.</p>
                                                </div>
                                            ...
                                            <li>
                                                <span className="sort-name">mw</span>
                                                <div>
                                            ...
                                            <li>
                                                <span className="sort-name">cg</span>
                                                <div>
                                                    <h5>Carmen Gomez</h5>
                                                    <p>Duis porta, ligula rhoncus euismod pretium, nisi tellus.</p>
                                                </div>
                                    ...
                                    <div className="col-lg-8 col-md-6 mt-4 mt-md-0 mt-lg-0">
                                        <h6 className="m-bold mb-3">This is the subject</h6>
                                        <div className="mini-profile mt-2">
                                            <span className="sort-name">rw</span>
                                            <div style={{flex: 1}}>
                                                <div className="row">
                                                    <div className="col-md-8"><h5>Rachel Wagner </h5></div>
                                                    <div className="col-md-4 mb-2 text-lg-right text-md-right ">
                                                        <span className="m-regular ">10, Sep 2020 - 19:15</span>
                                                    </div>
                                                </div>
                                                <p className="mb-0">rachelwagner@email.com <br />+1 1234 5678 9000</p>
                                            </div>
                                        </div>
