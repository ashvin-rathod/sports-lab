...
<div className="lrm-content">
  <div className="row align-items-center">
    <div className="col-lg-4">
      <h4 className="small-title">Venues
      </h4>
    </div>
    <div className="col-lg-8">
      <div className="search-flex">
       ...
       <Link to='/clientaddvenues' className="btn btn-primary add">Add Venue</Link>
  ...
  <div className="card mt-3">
    <div className="table-responsive">
       <table className="table">
          ...
          <tbody>
            <tr>
              <td><a href="venues-details-info.html">2358</a> </td>
              ...
              <td>
                 <a href="venues-details-info.html" className="action-btn"> <img src="images/svg/View.svg" alt='View' /></a>
