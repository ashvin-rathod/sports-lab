...
const ClientRecordInjuries = () => {
    return (
        <>
            <div className="lrm-content">
                <div className="row align-items-center">
                    <div className="col-lg-4">
                        <h4 className="small-title">Record Injuries <span className="mini-dot"></span>
                        </h4>
                    </div>
                    <div className="col-lg-8">
                        <div className="search-flex">
                            ...
                            <a href="#" className="btn btn-primary add">Report Injury</a>
...
export default ClientRecordInjuries
