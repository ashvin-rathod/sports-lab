...
const ClientRecordTestingResults = () => {
    return (
        <>
            <div className="lrm-content">
                <div className="row align-items-center">
                    <div className="col-lg-4">
                        <h4 className="small-title">Record Testing Results <span className="mini-dot"></span>
                    ...
                    <div className="col-lg-8">
                        <div className="search-flex">
                            ...
                            <a href="#" className="btn btn-primary add">Record Test Results</a>
...
export default ClientRecordTestingResults
